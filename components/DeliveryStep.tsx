  ...
  return (
    <div className="w-full h-full flex flex-col justify-center text-center animate-slide-in p-8">
      <div className="flex-grow flex flex-col items-center justify-center">
        <h2 className="text-4xl md:text-5xl font-bold text-black mb-2 text-balance">Como prefere receber?</h2>
        <p className="text-black/70 mb-12">Escolha a forma mais conveniente para você.</p>
        ...
        <div className="space-y-4 w-full max-w-sm mx-auto">
          ...
          <button
            ...
            className="w-full flex items-center justify-center text-left bg-white/50 text-black border-2 border-black/20 font-bold text-lg p-5 rounded-2xl shadow-md transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:bg-black hover:text-white focus:outline-none focus:ring-4 focus:ring-black/50"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mr-4 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
